...
class myThread_sign_02(threading.Thread):
    ...
    def run(self):
        thread_sign = {'platformName': 'Android', 'platformVersion': '5.1', 'deviceName': 'MT66-4WA-7K18623',
                       'appiumURL': 'http://192.168.1.82:4723/wd/hub'}# 'deviceName': 'MT66-4WA-7K18623','appiumURL': 'http://192.168.1.82:4723/wd/hub'
        user_info = {'userName':'13711110000','password':'111111'}
        print ("开始线程：" + self.name+'pda')
        sar = signAndRefuse()

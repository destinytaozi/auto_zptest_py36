...
class appDriver():
    def driver_app_driver(self,deviceName):
        desired_caps={}
        desired_caps['platformName'] = 'Android'   # 声明是ios还是Android系统 例如："Android"
        # desired_caps['platformVersion'] = '5.1'  # Android内核版本号，可以在夜神模拟器设置中查看 例如：'4.4.2'
